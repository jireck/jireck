...
<body>
	...
	// }
	function onMessage(message) { // IEだとonMessageが呼ばれないっぽい
	...
	//	token = null;
	//	userId = null;
		location.href = "/channel/disconnect?userListName=roomUserList&userId=" + userId + "&redirect=/live";
	}


	function send() {
		var url = "/channel/chat?userListName=roomUserList";
		var map = new Object();
		map["userId"] = userId;
